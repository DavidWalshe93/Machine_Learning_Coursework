...
Author:         David Walshe
Date:           05/04/2020
Desc:           Principle Component Analysis
"""
...
# import dataset
# ==============
dataset = pd.read_csv("9_dimensionality_reduction/pca/Wine.csv")
...
# Creates a vector with the cumulative variance explaining all the principle components.
# pca = PCA(n_components=None)

# After viewing variance vector (from Line above), decide on n_components to use.
