...
# import dataset
# ==============
dataset = pd.read_csv("2_regression/random_forest_regression/Position_Salaries.csv")
X = dataset.iloc[:, 1:2].values.reshape(-1, 1)
y = dataset.iloc[:, 2].values.reshape(-1, 1)

# # Feature Scaling required for Random Forest
# # ================================
...
# Setup Random forest with 10 trees
...
plt.title("Salary Guide (Random Forest Regression)")
